...
if __name__ == '__main__':
    ...
    # define poses
    poses = []
    poses.append(gtsam.PinholeCameraCal3_S2.Lookat(gtsam.Point3(10,0,0), gtsam.Point3(0,0,0), gtsam.Point3(0,0,1), gtsam.Cal3_S2()).pose())
    poses.append(gtsam.PinholeCameraCal3_S2.Lookat(gtsam.Point3(0,-10,0), gtsam.Point3(0,0,0), gtsam.Point3(0,0,1), gtsam.Cal3_S2()).pose())
    poses.append(gtsam.PinholeCameraCal3_S2.Lookat(gtsam.Point3(-10,0,0), gtsam.Point3(0,0,0), gtsam.Point3(0,0,1), gtsam.Cal3_S2()).pose())
    poses.append(gtsam.PinholeCameraCal3_S2.Lookat(gtsam.Point3(0,10,0), gtsam.Point3(0,0,0), gtsam.Point3(0,0,1), gtsam.Cal3_S2()).pose())
    poses.append(gtsam.PinholeCameraCal3_S2.Lookat(gtsam.Point3(10,0,0), gtsam.Point3(0,0,0), gtsam.Point3(0,0,1), gtsam.Cal3_S2()).pose())
    # define quadrics
